            ...
            <div class="content-left">
                <div class="left-content">
                    ...
                    <nav class="top-content">
                        ...
                        <a href="/usuarios/" class="item item-1">
                        ...
                        <a href="/productos" class="item item-2">
                        ...
                        <a href="/proveedores" class="item item-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                ...
                <div class="right-content">
                    ...
                    <form action="/newUser" method="post" id="frm-test" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="frow frow-5">
                            <div class="fitem fitem1-1-4">
                                <input type="text" name="username" id="username" required/>
                                <label for="username">Fertilizantes</label>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="frow frow-1">
                            <div class="fitem fitem1-1-4">
                                <input type="text" name="username" id="username" required/>
                                <label for="username">Tienpo del cultivo sembrado</label>
                            </div>
                            <div class="fitem fitem1-2">
                                <input type="text" id="funcion" name="funcion" required/>
                                <label for="funcion">Tiempo Recoleccion</label>
                            </div>
                            <div class="fitem fitem1-3">
                                <input type="correo" id="correo" name="correo" required/>
                                <label for="correo">producto recolectado</label>
                            </div>
